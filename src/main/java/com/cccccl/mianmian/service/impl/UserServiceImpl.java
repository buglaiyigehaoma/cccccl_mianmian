...
import static com.cccccl.mianmian.constant.UserConstant.USER_LOGIN_STATE;
...
import com.cccccl.mianmian.constant.RedisConstant;
import com.cccccl.mianmian.exception.BusinessException;
import com.cccccl.mianmian.mapper.UserMapper;
import com.cccccl.mianmian.model.dto.user.UserQueryRequest;
import com.cccccl.mianmian.model.entity.User;
import com.cccccl.mianmian.model.enums.UserRoleEnum;
import com.cccccl.mianmian.model.vo.LoginUserVO;
import com.cccccl.mianmian.model.vo.UserVO;
import com.cccccl.mianmian.satoken.DeviceUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "cccccl";
...
//        request.getSession().removeAttribute(USER_LOGIN_STATE);
    ...
    @Override
    public Map<LocalDate, Boolean> getUserSignInRecord2(long userId, Integer year) {
        if (year == null) {
            LocalDate date = LocalDate.now();
            year = date.getYear();
        }
