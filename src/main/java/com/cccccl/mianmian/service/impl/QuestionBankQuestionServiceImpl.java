...
import com.cccccl.mianmian.mapper.QuestionBankQuestionMapper;
import com.cccccl.mianmian.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
...
//        }
    ...
    @Transactional(rollbackFor = Exception.class)
    @Override
    public void batchAddQuestionsToBank2(List<Long> questionIdList, Long questionBankId, User loginUser) {
        // 参数校验
