...
import com.cccccl.mianmian.model.dto.questionBankQuestion.*;
import com.cccccl.mianmian.model.entity.QuestionBankQuestion;
import com.cccccl.mianmian.model.entity.User;
import com.cccccl.mianmian.model.vo.QuestionBankQuestionVO;
...
public class QuestionBankQuestionController {
    ...
    /**
     * 批量添加题目到题库（仅管理员可用） 没有优化的接口
     *
     * @param questionBankQuestionBatchAddRequest
     * @param request
     * @return
     */
    @PostMapping("/add/batch2")
    @SaCheckRole(UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> batchAddQuestionsToBank2(
            @RequestBody QuestionBankQuestionBatchAddRequest questionBankQuestionBatchAddRequest,
            HttpServletRequest request
    ) {
        ThrowUtils.throwIf(questionBankQuestionBatchAddRequest == null, ErrorCode.PARAMS_ERROR);
        ...
        questionBankQuestionService.batchAddQuestionsToBank2(questionIdList, questionBankId, loginUser);
        long endTime = System.currentTimeMillis();
        long duration = endTime - startTime;
        System.out.println("接口执行时间: " + duration + " 毫秒");
        return ResultUtils.success(true);
    }
